class Level3 extends Phaser.Scene {
    ...
    create() {
        ...
        this.finish.create(600, 420, "Finish").setScale(0.5).refreshBody();

        this.box = this.physics.add.staticGroup()
        this.box.create(300, 440, "Box").setScale(0.2).refreshBody();
        this.box.create(300, 340, "Box").setScale(0.2).refreshBody();
